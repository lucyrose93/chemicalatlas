    ...
    .then(glossary => {
      ...
      glossary.forEach(entry => {
        ...
        card.innerHTML = `
          ...
          ${isTruncated ? '<p class="read-more" style="color: #cc9966; font-style:italic; cursor: pointer; margin: 0.2rem 0;">...continue reading</p>' : ''}
          <p class="toggle-reference" style="color: #cc9966; cursor: pointer; margin-top: 0.5rem;">→ Show reference</p>
          <div class="reference" style="display: none; font-size: 0.9rem; margin-top: 0.25rem; color: #cc9966;">${entry.reference || ''}</div>
