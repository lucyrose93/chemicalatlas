# About the Chemical Atlas (work in progress)

The Chemical Atlas is an ongoing, collaborative project that explores how chemicals shape contemporary life across bodies, environments, and regulatory systems. Initiated by a team of researchers working across science, geography, design, and anthropology, the project is developed in dialogue with a wider community of practitioners — including artists, activists, educators, and affected communities.
...
The Chemical Atlas is not a finished product, but a space for collaborative inquiry — a tool for testing methods, sharing perspectives, and reflecting on how we understand and navigate the chemical conditions of the present.